...
st.write("Here we plot the data do we can have a more clear representation/ idea about it ")
...
if not os.path.exists('data/FixedTrain.csv'):
  train.to_csv('data/FixedTrain.csv')
if not os.path.exists('data/PreprocessedData.csv'):
